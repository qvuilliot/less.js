...
less.Parser = function Parser(env) {
    ...
    var imports = this.imports = {
        ...
        relRoot: env && env.relRoot || "",	// Relative path from root file
        ...
        push: function (path, callback) {
            ...
            //
            less.Parser.importer(path, this.paths, this.relRoot, function (e, root, contents) {
            ...
            entities: {
                ...
                url: function () {
                    ...
                    return new(tree.URL)((value.value || value.data || value instanceof tree.Variable)
                                        ? value : new(tree.Anonymous)(value), imports.paths, imports.relRoot);
                },
